...
REM
REM 功能：
REM   * 预先设置 BLURAY_CLASSPATH -> 本目录下 share\libbluray\libbluray.jar
...
REM    set BLURAY_CLASSPATH=D:\程序\mpv\share\libbluray\libbluray.jar
...
setlocal
  ...
  if exist "%HERE%share\libbluray\libbluray.jar" (
    set BLURAY_CLASSPATH=%HERE%share\libbluray\libbluray.jar
  )
  if not "%JAVA_HOME%"=="" (
